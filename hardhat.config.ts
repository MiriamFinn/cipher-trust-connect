...
// Support both hardhat vars and environment variables for INFURA_API_KEY
const INFURA_API_KEY: string = process.env.INFURA_API_KEY || vars.get("INFURA_API_KEY", "zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz");
// Support PRIVATE_KEY from environment variable (without saving to files)
...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    sepolia: {
      ...
      chainId: 11155111,
      url: INFURA_API_KEY ? `https://sepolia.infura.io/v3/${INFURA_API_KEY}` : "https://sepolia.infura.io/v3/",
    },
  },
  paths: {
    artifacts: "./artifacts",
